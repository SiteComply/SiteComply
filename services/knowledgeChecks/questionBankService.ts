...
const SYSTEM_PROMPT = [
  ...
  'check that verifies a worker understood THIS specific site induction. The goal',
  ...
  '  anything a worker would need from outside the briefing. If a fact is not in',
  '  the briefing, do not ask about it and do not assume it.',
  '- A worker who read the briefing must be able to answer with certainty.',
  '',
  ...
  '  3. Mandatory PPE and site rules the worker must follow.',
