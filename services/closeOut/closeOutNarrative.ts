...
export const CLOSE_OUT_SYSTEM_PROMPT = [
  ...
  '- include no personal data: never name an individual operative, and give no phone numbers or addresses.',
  '',
...
export const CLOSE_OUT_SUMMARY_SYSTEM_PROMPT = [
  ...
  '',
  'DO NOT RECITE THE COUNTS AS A LIST. A sentence of the form "the record counts were: one operative',
