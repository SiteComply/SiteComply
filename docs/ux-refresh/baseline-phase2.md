...
- Captured at: commit `a36f442` on branch `feature/ux-refresh`
...
| Site → Overview | 161 | 3 | **19** | 2 | 0 | 11 | 0 | 0 |
| Site → Worker Experience  ** BIGGEST ISSUE ** | 292 | 8 | **43** | 0 | 0 | 18 | 0 | 0 |
| Site → Compliance | 258 | 4 | **21** | 1 | 0 | 14 | 0 | 0 |
| Site → Workers | 146 | 3 | **37** | 4 | 0 | 7 | 0 | 0 |
| Site → Documents | 72 | 1 | **7** | 0 | 0 | 3 | 0 | 0 |
| Site → Access | 102 | 2 | **18** | 3 | 0 | 5 | 0 | 0 |
...
**Totals across in-scope screens — cards 104, incl. nested 483, permission gates 157.**
