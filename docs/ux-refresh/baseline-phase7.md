...
- Captured at: commit `34ab782` on branch `feature/ux-refresh`
...
| Check-ins register | 275 | 4 | **7** | 5 | 0 | 3 | 4 | 0 |
...
| Settings → Config templates | 115 | 0 | **18** | 1 | 0 | 5 | 0 | 0 |
| Settings → Permission templates | 101 | 0 | **17** | 1 | 0 | 5 | 0 | 0 |

**Totals across in-scope screens — cards 89, incl. nested 470, permission gates 162.**
...
```
16:  assertModuleView,
44:  assertModuleView(viewer, 'checkins');
46:  const canExport = permits(viewer.role, 'checkins', 'export');
```
### Worker detail
```
10:  assertModuleView,
...
```
8:  assertModuleView,
47:  assertModuleView(viewer, 'sites');
100:      {permits(viewer.role, 'sites', 'edit') ? (
```
### Settings → Permission templates
```
8:  assertModuleView,
31:  assertModuleView(viewer, 'sites');
```
