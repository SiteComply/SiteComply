#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260730160000_add_compliance_scheduler.
#
...
echo "== SC-020 PHASE 1 PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sc020_verify.ts

echo "== SC-020 PHASE 1 MIGRATION COMPLETE =="
