#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260802090000_add_contractor_permissions.
#
...
echo "== SC-022 PHASE 1 PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sc022_verify.ts

echo "== SC-022 PHASE 1 MIGRATION COMPLETE =="
