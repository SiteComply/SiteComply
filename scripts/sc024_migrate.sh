#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260807090000_add_close_out_packs.
#
...
echo "== SC-024 PHASE 1 PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sc024_verify.ts

echo "== SC-024 PHASE 1 MIGRATION COMPLETE =="
