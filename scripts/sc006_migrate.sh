#!/usr/bin/env bash
# SC-006 production migration — applies 20260724150000_add_induction_validity.
#
...
echo "== SC-006 PRODUCTION MIGRATION =="
...
echo "== SC-006 MIGRATION COMPLETE =="
