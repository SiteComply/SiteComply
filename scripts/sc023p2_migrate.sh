#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260805090000_add_assignment_roles_dates_panels.
#
...
echo "== SC-023 PHASE 2 PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sc023p2_verify.ts

echo "== SC-023 PHASE 2 MIGRATION COMPLETE =="
