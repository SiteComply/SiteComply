#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260803090000_add_sms_audit_and_toggle.
#
...
echo "== TWILIO SMS PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sms_verify.ts

echo "== TWILIO SMS MIGRATION COMPLETE =="
