#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260804090000_add_worker_site_assignments.
#
...
echo "== SC-023 PHASE 1 PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sc023_verify.ts

echo "== SC-023 PHASE 1 MIGRATION COMPLETE =="
