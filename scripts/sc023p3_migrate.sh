#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260806090000_add_site_access_requirements.
#
...
echo "== SC-023 PHASE 3 PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sc023p3_verify.ts

echo "== SC-023 PHASE 3 MIGRATION COMPLETE =="
