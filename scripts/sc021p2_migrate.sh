#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260801140000_add_site_config_templates.
#
...
echo "== SC-021 PHASE 2 PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sc021p2_verify.ts

echo "== SC-021 PHASE 2 MIGRATION COMPLETE =="
