#!/usr/bin/env bash
# SC-020 Phase 1 production migration — applies 20260730200000_add_compliance_escalation.
#
...
echo "== SC-020 PHASE 2 PRODUCTION MIGRATION =="
...
DATABASE_URL="$DBURL" npx tsx scripts/sc020p2_verify.ts

echo "== SC-020 PHASE 2 MIGRATION COMPLETE =="
